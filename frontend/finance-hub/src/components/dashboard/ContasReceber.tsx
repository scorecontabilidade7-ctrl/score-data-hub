...
type SortKey = "date" | "cliente" | "descricao" | "categoria" | "grupo" | "valor";
...
export function ContasReceber({ data, dateField }: { data: MovimentacaoFinanceira[]; dateField: DateField }) {
  ...
  }, [view, pendentes, recebidos, query, dateField, sortConfig]);
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-primary hover:bg-primary">
                ...
                <TableHead className="text-[11px] font-bold text-primary-foreground cursor-pointer select-none" onClick={() => handleSort("cliente")}>
